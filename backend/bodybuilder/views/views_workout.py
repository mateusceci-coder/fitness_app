...
class WorkoutExerciseList(generics.GenericAPIView):
    ...
    def get(self, request, format=None):
        workout_exercises = WorkoutExercise.objects.filter(workout__created_by=request.user)
    ...
    def post(self, request, format=None):
        ...
        for exercise_data in data['exercises']:
            ...
            WorkoutExercise.objects.create(workout=request.data['workout'], exercise=exercise, **exercise_data)
...
class BodyWorkoutList(generics.GenericAPIView):
    ...
    def post(self, request, format=None):
        ...
        for exercise_data in exercises_data:
            exercise, created = BodyExercise.objects.get_or_create(**exercise_data)
            WorkoutExercise.objects.create(workout=body_workout, exercise=exercise, **exercise_data)
