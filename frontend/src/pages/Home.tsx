    ...
    <section className="flex flex-col items-center max-w-5xl mx-auto">
      ...
      <div className="flex flex-col">
        <article className="grid md:grid-cols-2 gap-2 article mb-12 md:mb-2">
          ...
          />
          <div>
            <h2 className="text-3xl text-mainBlue text-center md:text-start mb-12 md:mb-2">Profile</h2>
        ...
        <article className="grid md:grid-cols-2 gap-2 article mb-12 md:mb-2">
          <div>
            <h2 className="text-3xl text-mainBlue text-center md:text-start mb-2">Exercises</h2>
            <p className="leading-7 md:text-start text-center">
              In the exercises tab, you can add an exercise and enter your{" "}
              <span className="highlighted-text">1 rep max (1RM),</span> as well
              as choose the equipment (bar, dumbbell or kettlebell) that was
              used. You also have the option to update the weight of the
        ...
        <article className="grid md:grid-cols-2 gap-2 mb-2 md:order-2 article">
          <div className="md:order-2">
            <h2 className="text-3xl text-mainBlue text-center md:text-start mb-2">Workouts</h2>
            <p className="leading-7 md:text-start text-center">
              In the workouts tab, you can <span className="highlighted-text">create your own workouts</span>{" "}
              using movements from the exercises tab or also create a new
              exercise. The CrossFit section is customized for each type of WOD,
              and in the weightlifting section, you will have a suggested load
              based on your weight and the number of repetitions.
            </p>
          </div>
          <img
